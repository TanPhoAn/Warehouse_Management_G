...
function suggestBinLocation() {
    var length = parseFloat(document.getElementById('shipmentLength').value);
    var width = parseFloat(document.getElementById('shipmentWidth').value);
